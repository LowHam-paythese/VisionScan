...
const change_cam_ip = async (checking_cam, changing_cam, subnet = '255.255.255.0', username, password) => {
    try {
        // //console.log(`camIP : ${camIP},ftpIP : ${ftpIP},ftpPass : ${ftpPass}`)
        ...
        const camera_api_call = (url, message) => {
            return new Promise((resolve, reject) => {
                ...
                getRequest.request(
                    function (data) {
                        //   // success callback
                        // //console.log('camera_api_call data: ' + data)
                    ...
                    function (errorCode) {
                        ...
                        //console.log('camera_api_call error: ', errorCode)
                        //   // error callback
        ...
        await camera_api_call(url, message)
            ...
            .catch((error) => {
                // //console.log('Cam setup reject ' + error)
